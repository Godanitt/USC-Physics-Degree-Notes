...
\section{Fenómeno de transporte}
\subsection{Movilidad}

La movilidad decrece con la temperatura. Por contra, cuando la temperatura empieza a ser mayorm, el efecto de las impurezas ionizadas deja de ser relevante, y comienza a ser relevante la debida a las vibraciones de la red cristalina (fonones). Para altas temperaturaas $\mu$ cae como $T^{-3/2}$, a la inversa de lo que crece el número de fonones. 

\subsection{Difusión}

La difusión es un proceso por el cual las partículas tienden a dispersarse o redistribuirse como restultado de su alta concentración en ciertas zonas del sólido o bajas concentraciones en otra zona a temperatura no nula. 

Las corrientes de difusión son directamente proporcionales a los gradientes de concetración de partículas (ley de Flick):
