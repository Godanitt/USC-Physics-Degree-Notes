...
\end{equation}
siendo constantes la mayor parte de los términos (constantes que dependen de la temperatura y la masa efectiva). La única variable sería $N$, la concentración de impurezas.
...
\begin{equation}
	n_T = \frac{c_n N_T n + c_p N_T p_1}{c_n(n+n-1)+c_p(p+p_1)}
\end{equation}
Obtenemos
...
\begin{texercise}
	Calcular la resistividad del GaAs intrínseco a temperatura ambiente con los siguientes datos:
	\[
		\mu_n = 9200 \, \text{cm}^2/\text{Vs}, \quad \mu_p = 320 \, \text{cm}^2/\text{Vs}.
	\]
	\tcblower
	Hola
\end{texercise}
...
\begin{texercise}
	\textbf{Movilidad en el silicio}
	\begin{itemize}
		\item[(a)] La movilidad de los electrones en el silicio es \(\mu_n = 1300 \, \text{cm}^2/\text{Vs}\) a temperatura ambiente. Si asumimos que la movilidad está limitada principalmente por la dispersión con la red cristalina, calcular la movilidad a \(T= 150 K\).
		\item[(b)] Dos mecanismos de dispersión tienen lugar en un semiconductor. Si sólo el primer mecanismo está presente, la movilidad es de \(250 \, \text{cm}^2/\text{Vs}\). Si sólo el segundo mecanismo está presente, la movilidad es de \(500 \, \text{cm}^2/\text{Vs}\). Calcular la movilidad cuando los dos mecanismos de dispersión están presentes simultáneamente.
	\end{itemize}
...
\begin{texercise}
	\textbf{Concentraciones y resistividades en muestras de silicio}
...
\begin{texercise}
	\textbf{Campo eléctrico interno en un semiconductor}
	\begin{itemize}
...
\begin{texercise}
	\textbf{Tasa de recombinación en una muestra de Si tipo N}
...
\begin{texercise}
	\textbf{Efecto de la iluminación en un semiconductor}
	\begin{itemize}
...
\begin{texercise}
	\textbf{Diagrama de bandas de un semiconductor}
	...
	\begin{itemize}
		\item[(a)] Si el semiconductor de Si se mantiene a temperatura ambiente, determinar la resistividad del semiconductor para la región \(x > W/2\).
		\item[(b)] Para los electrones en la región \(x > W/2\) que intentan moverse a la región \(x < -W/2\) sin modificar su energía total, ¿cuál es la mínima energía cinética que deben tener?
		\item[(c)] Calcular y representar gráficamente el potencial electrostático y el campo eléctrico en función de \(x\). Explicar si el semiconductor está en equilibrio termodinámico.
		\item[(d)] Responder las siguientes preguntas:
		      \begin{itemize}
