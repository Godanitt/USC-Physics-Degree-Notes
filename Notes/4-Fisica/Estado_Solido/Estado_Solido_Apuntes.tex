...
%\usepackage[style = ieee,backend = biber,isbn = false,maxbibnames = 6, (6),minnames=1] {biblatex} %% Número máximo de autores que pueden aparecer en una referencia , Número mínimo de autores que aparecerán al truncar: autor1 et al.
