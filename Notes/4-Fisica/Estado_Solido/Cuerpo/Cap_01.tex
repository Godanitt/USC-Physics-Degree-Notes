...
\begin{table}[h!] \centering
	\begin{tabular}{lccc}
		...
		Distancia entre primeros vecinos & $a$ & $a\sqrt{3}/2$ & $a/\sqrt{2}$ \\ \hline
...
\begin{figure}[h!]  \centering
\includegraphics[width=0.8\textwidth]{Cuerpo/Ch_01/ejemplos.png}
\caption{Estructuras de diferentes materiales.}
\end{figure}
