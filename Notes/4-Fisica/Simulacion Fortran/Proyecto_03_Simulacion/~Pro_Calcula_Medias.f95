...
!     Variables que necesitamos      
      ...
      read(50,9006) 'Ec_tot=',Et
      read(50,9006) 'Ec_media=',Ec
      read(50,9006) 'Ecinv_media=',Ecinv
      read(50,9006) 'dfiv_media=',dfiv
      read(50,9006) 'd2fiv_media=',d2fiv
      read(50,9006) 'dfivEcinInv_media=',dfivEcInv
      read(50,9006) 'd2fivEcinInv_media=',dfiv2EcInv
      read(50,9000) '##############################'
      close(50)
