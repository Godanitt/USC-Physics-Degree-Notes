...
Una vez hacemos todos los pasos del procedimiento podemos obtener los resultados medios y las incertidumbres en la siguiente tabla:
...
\label{Tab:01}
\end{table}
Mientras que por otro lado en la tabla \ref{Tab:02} tenemos los valores experimentales (los promediados de la estadística de los 500K pasos). 
