...
Veamos entonces cuales son las interacciones que tendremos en cuenta (resumen):
\begin{itemize}
...
\begin{minipage}{0.45\linewidth} \centering
    \captionof{figure}{Radiación ionizante primaria \cite{DetectoresTECIV}.}
    \includegraphics[width=0.9\linewidth]{Cuerpo/Ch_01/Detectores_01.png}
\end{minipage}
\hfill
\begin{minipage}{0.45\linewidth} \centering
    \captionof{figure}{Radiación ionizante secundaria \cite{DetectoresTECIV}.}
    \includegraphics[width=0.9\linewidth]{Cuerpo/Ch_01/Detectores_01.png}
\end{minipage}
