...
void Angulos_hacer(const char* filename, const char* pdf) {
    ...
    TF1* fexp2 = new TF1("fexp2", "[0] + [1]*pow(cos(x*TMath::Pi()/180), [2])", xmin, xmax);
    ...
    legend->AddEntry(fexp2, "Ajuste:a + b cos^{n}(#theta)", "l");
    legend->Draw();
...
int Angulos() {
    ...
    const char* pdf1="../Graficas/Angulos.pdf";
    Angulos_hacer( archivo1,pdf1);

    const char* archivo2="Angulos_2.csv";
    const char* pdf2="../Graficas/Angulos_2.pdf";
